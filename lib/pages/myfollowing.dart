...
class MyFollowing extends StatefulWidget {
  MyFollowing(this.user);
  final String user;
  static const route = '/myfollowing';
  @override
...
class _MyFollowingState extends State<MyFollowing> {
  ...
  getFollowInfo([int? page]) async {
    if (page != null) {
      var response;
      try {
        response = await followerService.getFollowing(widget.user);
        return response;
      } catch (e) {
        print(e);
      ...
      var response;
      try {
        response = await followerService.getFollowing(widget.user, page);
        return response;
      } catch (e) {
        print(e);
        final snackBar = SnackBar(
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: Text(
                'There was an error getting the people you are following',
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontWeight: FontWeight.bold,
                    fontSize: 30,
